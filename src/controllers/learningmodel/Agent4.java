...
public class Agent4 extends AbstractPlayer {

    protected Classifier m_model;

    public Agent4(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
        try{
            ObjectInputStream input = new ObjectInputStream(new FileInputStream("lv4-1.model"));
