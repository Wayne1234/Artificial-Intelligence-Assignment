...
public class Agentvx extends AbstractPlayer {

    protected Classifier m_model;

    public Agentvx(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
        try{
            ObjectInputStream input = new ObjectInputStream(new FileInputStream("vx.model"));
