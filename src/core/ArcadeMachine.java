...
public class ArcadeMachine
{
                                    ...
                                    String agentName, String actionFile, int randomSeed, boolean isHuman)
    {
        ...
        String lv="LV0";
        if(level_file.equals("examples/gridphysics/aliens_lvl2.txt"))
            lv="LV2";
        else if(level_file.equals("examples/gridphysics/aliens_lvl1.txt"))
            lv="LV1";
        else if(level_file.equals("examples/gridphysics/aliens_lvl3.txt"))
            lv="LV3";
        else if(level_file.equals("examples/gridphysics/aliens_lvl4.txt"))
            lv="LV4";
        System.out.print(lv+"\t");
